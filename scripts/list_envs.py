...
All the environments are registered in the `custom_unitree_go2` extension. They start
...
import custom_unitree_go2.tasks  # noqa: F401


def main():
    """Print all environments registered in `custom_unitree_go2` extension."""
